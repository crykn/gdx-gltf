...
public class PBRShader extends DefaultShader {
	...
	public final static Uniform baseColorTextureUniform = new Uniform("u_diffuseTexture",
	...
	public final static Uniform baseColorFactorUniform = new Uniform("u_BaseColorFactor",
	...
	public final static Uniform emissiveTextureUniform = new Uniform("u_emissiveTexture",
	...
	public final static Uniform normalTextureUniform = new Uniform("u_normalTexture",
	...
	public final static Uniform metallicRoughnessTextureUniform = new Uniform("u_MetallicRoughnessSampler",
	...
	public final static Setter metallicRoughnessSetter = new LocalSetter() {
		@Override
		public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
			PBRFloatAttribute metallicAttribute = combinedAttributes.get(PBRFloatAttribute.class,
					PBRFloatAttribute.Metallic);
			PBRFloatAttribute roughnessAttribute = combinedAttributes.get(PBRFloatAttribute.class,
	...
	public final static Setter normalScaleSetter = new LocalSetter() {
		@Override
		public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
			PBRFloatAttribute normalScaleAttribute = combinedAttributes.get(PBRFloatAttribute.class,
					PBRFloatAttribute.NormalScale);
	...
	public final static Setter occlusionStrengthSetter = new LocalSetter() {
		@Override
		public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
			PBRFloatAttribute occlusionStrengthAttribute = combinedAttributes.get(PBRFloatAttribute.class,
	...
	public final static Uniform occlusionTextureUniform = new Uniform("u_OcclusionSampler",
	...
	public final static Uniform diffuseEnvTextureUniform = new Uniform("u_DiffuseEnvSampler",
			PBRCubemapAttribute.DiffuseEnv);
	public final static Setter diffuseEnvTextureSetter = new LocalSetter() {
		@Override
		public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
			PBRCubemapAttribute diffuseEnvAttribute = combinedAttributes.get(PBRCubemapAttribute.class,
					PBRCubemapAttribute.DiffuseEnv);
	...
	public final static Uniform specularEnvTextureUniform = new Uniform("u_SpecularEnvSampler",
			PBRCubemapAttribute.SpecularEnv);
	public final static Setter specularEnvTextureSetter = new LocalSetter() {
		@Override
		public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
			PBRCubemapAttribute specularEnvAttribute = combinedAttributes.get(PBRCubemapAttribute.class,
					PBRCubemapAttribute.SpecularEnv);
	...
	public final static Setter brdfLUTTextureSetter = new LocalSetter() {
		@Override
		public void set(BaseShader shader, int inputID, Renderable renderable, Attributes combinedAttributes) {
			PBRTextureAttribute attribute = combinedAttributes.get(PBRTextureAttribute.class,
	...
	private static long[] allTextureTypes = { PBRTextureAttribute.BaseColorTexture, PBRTextureAttribute.EmissiveTexture,
			PBRTextureAttribute.NormalTexture, PBRTextureAttribute.MetallicRoughnessTexture,
			PBRTextureAttribute.OcclusionTexture };
	...
	protected void bindMaterial(Attributes attributes) {
		...
		// TODO texCoords should be mapped in vertex shader to allow separated UV
		// transform
	...
	public void render(Renderable renderable, Attributes combinedAttributes) {
		...
		if (u_mipmapScale >= 0) {
			PBRCubemapAttribute specularEnv = combinedAttributes.get(PBRCubemapAttribute.class,
					PBRCubemapAttribute.SpecularEnv);
			float mipmapFactor;
			if (specularEnv != null) {
		...
		if (u_morphTargets1 >= 0) {
			if (renderable.userData instanceof WeightVector) {
				...
				program.setUniformf(u_morphTargets1, weightVector.get(0), weightVector.get(1), weightVector.get(2),
						weightVector.get(3));
			} else {
		...
		if (u_morphTargets2 >= 0) {
			if (renderable.userData instanceof WeightVector) {
				WeightVector weightVector = (WeightVector) renderable.userData;
				program.setUniformf(u_morphTargets2, weightVector.get(4), weightVector.get(5), weightVector.get(6),
						weightVector.get(7));
			} else {
	...
	protected void bindLights(Renderable renderable, Attributes attributes) {
		...
		DirectionalLightsAttribute dla = attributes.get(DirectionalLightsAttribute.class,
