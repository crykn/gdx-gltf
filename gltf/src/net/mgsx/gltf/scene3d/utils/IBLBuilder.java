...
/**
 * Quick procedural IBL environment generation. Should be disposed when no
 * longer used.
 * 
 * IBL generated by this class are accurate, some fast approximation are
 * performed to provide a quick way to setup an IBL environment. For accurate
 * IBL, see: https://learnopengl.com/PBR/IBL/Specular-IBL and
 * https://learnopengl.com/PBR/IBL/Diffuse-irradiance and related tools to
 * generate them from HDRIs.
 * 
 * @author mgsx
 *
 */
public class IBLBuilder implements Disposable {
	...
	private IBLBuilder() {
		...
		sunShader = new ShaderProgram(Gdx.files.classpath("net/mgsx/gltf/shaders/ibl-sun.vs.glsl"),
	 ...
	 * {@link net.mgsx.gltf.scene3d.scene.SceneSkybox}
	 * 
	 * @param size
	 *            base size (width and height) for generated cubemap
	 * @return generated cubemap, caller is responsible to dispose it when no longer
	 *         used.
	 */
	 ...
	 * {@link net.mgsx.gltf.scene3d.attributes.PBRCubemapAttribute#DiffuseEnv}
	 * 
	 * @param size
	 *            base size (width and height) for generated cubemap
	 * @return generated cubemap, caller is responsible to dispose it when no longer
	 ...
	 * {@link net.mgsx.gltf.scene3d.attributes.PBRCubemapAttribute#SpecularEnv}
	 * generated cubemap contains mipmaps in order to perform roughness in PBR
	 * shading
	 * 
	 * @param levels
	 *            mipMapLevels how many mipmaps level, eg. 10 levels produce a
	 *            1024x1024 cubemap with mipmaps.
	 * @return generated cubemap, caller is responsible to dispose it when no longer
	 *         used.
	 */
