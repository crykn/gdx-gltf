...
public class EnvironmentUtil {
	...
	public static Cubemap createCubemap(FileHandleResolver resolver, String baseName, String extension,
			String[] faceNames) {
		Cubemap cubemap = new Cubemap(resolver.resolve(baseName + faceNames[0] + extension),
	...
	public static Cubemap createCubemap(FileHandleResolver resolver, String baseName, String midName, String extension,
			int lods, String[] faceNames) {
