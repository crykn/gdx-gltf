...
public class Scene implements RenderableProvider, Updatable {
	...
	/**
	 * Default constructor create animated scene if model contains animations. use
	 * {@link #Scene(Model, boolean)} constructor to force animation management.
	 * 
	 * @param model
	 */
	...
	/**
	 * Default constructor create animated scene if model instance contains
	 * animations. use {@link #Scene(Model, boolean)} constructor to force animation
	 * management.
	 * 
	 * @param modelInstance
	 */
