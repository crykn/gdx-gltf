...
public class SceneManager implements Disposable {
	...
	/**
	 * render all scenes. because shadows use frame buffers, if you need to render
	 * scenes to a frame buffer, you should instead first call
	 * {@link #renderShadows()}, bind your frame buffer and then call
	 * {@link #renderColors()}
	 */
	public void render() {
		if (camera == null)
